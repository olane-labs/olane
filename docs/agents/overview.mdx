...
### Intent-Based Invocation {#intent-based-invocation}
...
### Direct Tool Invocation {#direct-tool-invocation}
...
### Pattern 1: Human-Initiated, AI-Executed {#human-initiated-ai-executed}
...
### Pattern 2: Pure AI Autonomous {#pure-ai-autonomous}
...
### Pattern 3: Human Direct Execution {#human-direct-execution}
...
### Pattern 4: Hybrid Collaboration {#hybrid-collaboration}
...
### Build Once, Serve Both {#build-once-serve-both}
...
### Gradual AI Adoption {#gradual-ai-adoption}
...
### Example 1: Customer Support System {#example-customer-support}
...
### Example 2: Financial Analysis {#example-financial-analysis}
...
### Example 3: Data Pipeline Orchestration {#example-data-pipeline}
...
### Pattern: Progressive Enhancement {#progressive-enhancement}
...
### Pattern: Human-in-the-Loop {#human-in-the-loop}
...
### Pattern: Hybrid Expertise {#hybrid-expertise}
